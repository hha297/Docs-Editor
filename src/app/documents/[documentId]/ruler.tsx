...
export const Ruler = () => {
                ...
                if ((isDraggingLeft || isDraggingRight) && rulerRef.current) {
                        ...
                        if (container) {
                                ...
                                if (isDraggingLeft) {
                                        ...
                                        setLeftMargin(newLeftMargin); //TODO: Make collaboration with right margin
                                } else if (isDraggingRight) {
                                        const maxRightMargin = PAGE_WIDTH - (leftMargin + MINIMUM_SPACE);
                                        const newRightMargin = Math.max(PAGE_WIDTH - rawPosition, 0);
                                        const constrainedRightMargin = Math.min(newRightMargin, maxRightMargin);
                                        setRightMargin(constrainedRightMargin); //TODO: Make collaboration with left margin
                                }
                        }
                }
        };
        ...
        const handleLeftDoubleClick = () => {
                setLeftMargin(56); // Reset left margin
        };

        const handleRightDoubleClick = () => {
                setRightMargin(56); // Reset right margin
        };
        return (
                <div
                        ref={rulerRef}
                        ...
                        className="h-6 border-b mt-2 border-gray-300 flex items-end relative select-none print:hidden"
                >
